...
pub fn part1(input: &[u8]) -> usize {
    ...
    (1..(LENGTH)).into_iter().for_each(|y|matrix[y*LENGTH - 1] = true);
    (1..(LENGTH-1)).into_iter().for_each(|y|matrix[y*LENGTH] = true);
    ((LENGTH-1)*LENGTH..LENGTH*LENGTH).into_iter().for_each(|id|matrix[id] = true);
